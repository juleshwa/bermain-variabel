...
// Tulis kode anda di sini
// // gunakan substring
let kucing = kalimatDua.substring(0, 4);
let sapi= kalimatDua.substring(5, 15);
let ayam = kalimatDua.substring(16, 23);
let bebek = kalimatDua.substring(24, 29);
let cicak = kalimatDua.substring(30, 37);

// console.log('First Word: ' + exampleFirstWord3);
// // Tulis kode ada di sini
console.log ('            ' +  'Tugas III' + '      ');
console.log ('------------------------------');
console.log("First word: " + kucing);
console.log('Second word: ' + sapi);
console.log('Third word: ' + ayam);
console.log('Fourth word: ' + bebek);
console.log('Fifth word: ' + cicak);
