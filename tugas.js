...
var words = kalimatTiga.split(" ");
for (var i = 0; i < words.length - 1; i++) {
    console.log((i+1)+' Word ' + words[i] + ', with length ' + words[i].length);
}
